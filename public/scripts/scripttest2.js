...
const scoreArray = [parseInt(getCookie("score1")), parseInt(getCookie("score4")), parseInt(getCookie("score2")),parseInt(getCookie("score5")),parseInt(getCookie("score4")),parseInt(getCookie("score6"))];
...
window.onload = function() {
  ...
  var geoSuccess = function(position) {
    ...
    for(i=0;i<outputArray.length;i++){
        if(outputArray[i][14]){
            var testcoords = {lat: outputArray[i][14], lng:  outputArray[i][15]};
